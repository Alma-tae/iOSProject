...
//화면에 보여지기 전에 호출되서 화면을 만드는 역할을 하는 클래스
class SceneDelegate: UIResponder, UIWindowSceneDelegate {

    var window: UIWindow?

    //AppDelegate 에 의해서 SceneDelegate가 호출될 때 실행되는 메서드
